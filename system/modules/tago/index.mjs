  ...
  try {
    ...
    if (r.items.length === 0) {
      ...
      if (action === 'subway-timetable' && String(data.dailyTypeCode) === '02') {
        ...
        notes.push('⚠️ dailyTypeCode 02 (토요일) returns zero on every line measured — 8 of 8, including lines whose 평일 and 일요일 tables are full. TAGO appears to publish two tables, 평일 (01) and 휴일 (03), and 02 is a documented code with no data behind it. Asked for a Saturday timetable, use 03 and say it is the 휴일 table.');
      }
