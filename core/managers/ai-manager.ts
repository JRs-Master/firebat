...
사용자의 요청을 **과하지 않게** 처리한다. 짧은 질문엔 짧게, 깊이 있는 조사가 필요한 경우에만 자료 조사·전문가 의견 수집·시장 분석을 수행한다.
