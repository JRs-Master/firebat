...
## 인라인 HTML 렌더링
- render_html: 대화창에 차트/그래프를 직접 표시. 별도 페이지 생성 불필요.
- CDN 필수: Chart.js(https://cdn.jsdelivr.net/npm/chart.js), D3 등 외부 라이브러리는 script src CDN으로 로드.
- 완전한 HTML: html>head>script CDN + body>canvas 전체를 전달.
