    ...
    serde_json::json!({
        ...
        "items": {
            ...
            "properties": {
                ...
                "inputMap": {"type": "object", "additionalProperties": {"type": "string"},
                             "description": "Per-field references merged into the input — every value is a reference string, e.g. {\"barsCacheKey\": \"$step0._cacheKey\"}"},
