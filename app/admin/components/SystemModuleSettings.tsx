...
const MODULE_SETTINGS_SCHEMA: Record<string, { title?: string; fields: SettingField[] }> = {
  ...
  'cms': {
    fields: [
      ...
      { key: 'kakaoMapJsKey', label: '카카오맵 JavaScript 키 (선택)', type: 'text', tab: '레이아웃', placeholder: '카카오 디벨로퍼스 → 앱 → 앱 키 → JavaScript 키', description: 'render_map 도구가 한국 좌표 표시 시 카카오맵 사용. 미설정 시 Leaflet+OSM 폴백. 카카오톡 모듈의 REST API 키와 다름.' },
